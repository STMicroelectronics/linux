...
MODULE_PARM_DESC(require_dtr, "Block TX (write_room=0) until host asserts DTR");
...
struct gs_port {
	...
	bool			host_dtr;
	bool			host_rts;
	unsigned int		modem_status;	/* TIOCM_* live bits */
	unsigned int		modem_delta;	/* TIOCM_* changes since last wait */
